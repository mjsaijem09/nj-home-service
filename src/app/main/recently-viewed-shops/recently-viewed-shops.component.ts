...
@Component({
  selector: 'app-recently-viewed-shops',
  templateUrl: './recently-viewed-shops.component.html',
  styleUrls: ['./recently-viewed-shops.component.scss']
})
export class RecentlyViewedShopsComponent implements OnInit {
  shops:any = [];
  constructor(
