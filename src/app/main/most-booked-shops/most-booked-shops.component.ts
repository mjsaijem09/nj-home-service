...
@Component({
  selector: 'app-most-booked-shops',
  templateUrl: './most-booked-shops.component.html',
  styleUrls: ['./most-booked-shops.component.scss']
})
export class MostBookedShopsComponent implements OnInit {
  shops:any = [];
  constructor(
